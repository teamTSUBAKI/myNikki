...
class WalkTroughViewController: UIPageViewController,UIScrollViewDelegate {
    ...
    let pageNum = 2
    let pageImage:[Int:String] = [0:"4-inch (iPhone 5) - Screenshot 1",1:"4-inch (iPhone 5) - Screenshot 2"]
    ...
    override func viewDidLoad() {
       ...
       // getAllPhotos()
        ...
        self.view.backgroundColor = colorFromRGB.colorWithHexString("0fb5c4")
        ...
        for p in 1...pageNum{
            ...
            print(screenHeight)
                ...
                case 480:
                    ...
                    v.backgroundColor = colorFromRGB.colorWithHexString("0fb5c4")
